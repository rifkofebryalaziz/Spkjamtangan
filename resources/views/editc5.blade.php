...
<body>
    <div class="container" >
        <form action="{{ route('user.updatec5', $baterai->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="namaKriteria">Nama Sub Kriteria C5</label>
                <input type="text" name="Namasubkrtc5" value="{{ $baterai->nama_sub5 }}" class="form-control" id="namasubKriteria" placeholder="Masukan Nama Sub Kriteria">
            </div>
            {{-- @error('NamaKrt')
            ...
            <div class="form-group">
                ...
                <input type="text" name="nilaic5" value="{{ $baterai->nilai5 }}" class="form-control" id="nilai" placeholder="Masukan Nilai">
            </div>
